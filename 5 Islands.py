def 5islands():
    5isyn = input("Are you sure that you'd like to begin this side quest?(Y/N)").strip().title()
    if 5isyn == ("N"):
...
#----------------------------------------------------------------------------------
def 5is():
    input("You set out to sea, the calmness of the water is relaxing and soothing.")
