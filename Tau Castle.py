...
if tau == "blacksmith":
    ...
    taucha = input("As you look at the rows and rows of food, you hear a loud scream and a man running. Thief! Do you want to chase him or back off?").strip().lower()
        if taucha == "chase":
            input("You decide to chase after the theif")
            #Combat section once we get that, prize LVL 2 armor
        elif taucha == "back off":
